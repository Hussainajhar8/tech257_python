...
for data in embedded_lists:
    ...
    for num in data:
        print(num)
# Loop through a dictionary Write another for loop to loop through the dictionary 'dict_data'. It should print the keys to the screen like this:
# 1
# 2
# 3
for keys in dict_data:
    print(keys)
# Loop through a dictionary and print its values Write another for loop to loop through the dictionary 'dict_data'. Use to the dictionary's value() method to print the value for each key in the dictionary. Output should be:
# {'name': 'Bronson', 'money': '$0.05'}
# {'name': 'Masha', 'money': '$3.66'}
# {'name': 'Roscoe', 'money': '$1.14'}
for values in dict_data.values():
    print(values)
# Loop to print the values of the dictionary items inside a dictionary Copy and paste the last for loop as a starting point for this loop. Generate an embedded for loop (a loop within a loop) to extract and print the values within the dictionary of each item in the dictionary. Output should be:
# Bronson
# $0.05
# Masha
# $3.66
...
for values in dict_data.values():
    for item in values.values():
        print(item)
# Loop to print specific values of the dictionary items inside a dictionary Write another for loop to loop through the dictionary 'dict_data' but this time only print out the money values. Output should be:
# $0.05
# $3.66
# $1.14
for values in dict_data.values():
